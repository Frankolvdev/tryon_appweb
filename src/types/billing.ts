...
export type TokenPurchaseList = { items: TokenPurchase[]; total: number; skip: number; limit: number };
...
export type BillingPaymentList = { items: BillingPayment[]; total: number; skip: number; limit: number };
...
export type BillingInvoiceList = { items: BillingInvoice[]; total: number; skip: number; limit: number };
