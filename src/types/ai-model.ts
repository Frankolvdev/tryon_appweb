...
export interface AiModelProfile { id:number; name:string; sex:ModelSex; body_proportion_preset_id:number|null; bubble_butt_preset_id:number|null; bubble_butt_variant_index:number|null; body_image_url:string|null; generated_image_url?:string|null; selected_generation_file_id?:number|null; stage:string; draft_json?:Record<string,unknown>; created_at:string; updated_at:string; }
