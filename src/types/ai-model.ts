...
export interface AiModelProfile { id:number; name:string; sex:ModelSex; body_proportion_preset_id:number|null; body_image_url:string|null; stage:string; created_at:string; updated_at:string; }
